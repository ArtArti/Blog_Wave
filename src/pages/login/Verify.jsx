...
const Verify = () => {
  ...
  async function handleSignIn(e) {
    ...
    try {
      ...
      // Check cookies in the browser (inspect -> application -> cookies)
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-sm p-4 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 bg-gray-400 m-4">
